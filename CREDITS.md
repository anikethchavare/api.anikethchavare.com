...
1. [numpy](https://github.com/numpy/numpy) v2.5.1 - License: [Custom](https://github.com/numpy/numpy/blob/main/LICENSE.txt)
2. [redis](https://github.com/redis/redis-py) v8.0.1 - License: [MIT](https://github.com/redis/redis-py/blob/master/LICENSE)
...
9. [FastAPI](https://github.com/tiangolo/fastapi) v0.139.2 - License: [MIT](https://github.com/fastapi/fastapi/blob/master/LICENSE)
...
13. [pydantic-settings](https://github.com/pydantic/pydantic-settings) v2.14.2 - License: [MIT](https://github.com/pydantic/pydantic-settings/blob/main/LICENSE)